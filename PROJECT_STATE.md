...
| Twilio SIP Domain | **`opiflow.sip.twilio.com`** (US1; Asterisk dials `opiflow.sip.us1.twilio.com`; «A call comes in» = inbound webhook **POST**; IP-ACL `opiflow` = `46.224.138.115/32`, no credential list) |
