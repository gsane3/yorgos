...
- **2026-06-09 — session 12 — 🎨 UX/UI REDESIGN (phone-first messenger) — plan + P0/P1 + P2a/P2b:**
  ...
  - **⏭️ NEXT (P2c):** Settings 6 categories (Επιχείρηση/Τηλεφωνία/**Κατάλογος**/Δεδομένα/Λογαριασμός/Ειδοποιήσεις/Στατιστικά) · Κλήσεις customer-search bar on top · **SendChannelSheet unify + WhatsApp removal → re-apply migration 042**. Then **P3 — Messenger customer card** (`/api/customers/[id]/timeline`, chat bubbles, info panel, brief timeline).
